resource "random_password" "db_admin_password" {
 ...
 resource "aws_security_group_rule" "mysql" {
    ...
    description = "TCP/3306 for ecs instance "
    type = "ingress"
    protocol "tcp"
    from_port=3306
    to_port = 3306
 ...
 resource "aws_db_instance" "prod" {
    identifier = "${var.platform_type}-${var.environment_name}-rds_instance"
    ...
    tags = {
        Name = "${var.platform_type}-${var.environment_name}-rds_instance"
    }
 }